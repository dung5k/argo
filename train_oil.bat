...
.\venv\Scripts\python.exe src\core\feature_engineering.py data\bot_config_oil.json
echo.
echo 3. Bat dau Dao tao (Training)...
.\venv\Scripts\python.exe src\core\train_unified.py data\bot_config_oil.json
pause
