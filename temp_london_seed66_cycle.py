...
run_id = f'run_{run_timestamp}_v6_LONDON_5m_TP8_SL3_Drop30_W15_FarmSeed66'
...
# ---- APPEND DIARY ----
diary_text = """
### STATE UPDATE: 2026-05-14 09:23
- **Run ID:** run_20260514_091706_v6_LONDON_5m_TP8_SL3_Drop30_W15_FarmSeed65
- **Kết quả:** Best Val Loss tại Epoch 5 (Val Loss: **0.4999** — Đột phá ranh giới 0.50!). Composite Score: **0.1411**, Win Rate: **27.85%** (Threshold 0.80), **48.72%** (Threshold 0.93, N=39).
- **Phân tích:** Score tiếp tục dao động ở mức trung bình (0.1411), nhưng có một điểm CỰC KỲ đáng chú ý: Val Loss lần đầu tiên xuyên thủng mốc 0.500 (đạt 0.4999). Điều này chứng tỏ mô hình đang fit với validation data tốt hơn về mặt phân bố xác suất tổng thể. WR@0.93 duy trì 48.72%.
- **Ý tưởng tiếp theo (Seed 66):** Đây là tín hiệu mô hình đang "đào" rất sâu. Tiếp tục giữ cấu hình. Mốc 0.1810 vẫn là điểm target của Score.
"""
with codecs.open('workspaces/CFG_LTC_LONDON_V6/LONDON_V6_DIARY.md', 'a', encoding='utf-8') as f:
    f.write(diary_text)

# ---- TELEGRAM REPORT THEO MẪU ----
msg = f"""🏯 [LONDON V6 MTF] Tạo Run Mới (FarmSeed 66).

📊 Kết quả FarmSeed 65:
- Best Val Loss tại Epoch 5. Composite Score: 0.1411
- Win Rate: 27.85% (Threshold 0.80) | 48.72% (Threshold 0.93)
...
🚨 Val Loss của Seed 65 vừa phá vỡ mốc 0.500 (xuống 0.4999) lần đầu tiên! Mặc dù Score tạm giảm, việc Val Loss xuyên thủng đáy cho thấy mô hình đang đào rất sâu vào dữ liệu. 🚀 FarmSeed 66 (PID {pid}) đã bùng cháy! Mục tiêu: Bắt sóng Score từ Val Loss mới!"""
