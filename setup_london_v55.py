...
run_id = f'run_{run_timestamp}_v6_LONDON_5m_TP8_SL3_Drop30_W15_FarmSeed55'
...
# Fix TRAINING params properly for London
...
# Only keep the first MTF input and force it to 5min, W15
