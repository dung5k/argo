...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_030000_v6_weekend_continuous_22\config.json'
...
config['TRAINING']['DROPOUT_RATE'] = 0.01
