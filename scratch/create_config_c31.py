...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_033700_v6_weekend_continuous_31\config.json'
...
config['TRAINING']['FOCAL_GAMMA'] = 0.5
