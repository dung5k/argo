...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_011500_v6_weekend_continuous_15\config.json'
...
config['FEATURE_ENGINEERING']['TP_PCT'] = 0.002
