...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_031600_v6_weekend_continuous_26\config.json'

with open(config_path, 'r', encoding='utf-8') as f:
    config = json.load(f)

config['TRAINING']['BATCH_SIZE'] = 16
config['TRAINING']['LEARNING_RATE'] = 0.00025
