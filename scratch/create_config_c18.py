...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_024500_v6_weekend_continuous_18\config.json'
...
config['TRAINING']['FOCAL_GAMMA'] = 1.0
