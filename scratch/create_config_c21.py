...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_025800_v6_weekend_continuous_21\config.json'
...
config['FEATURE_ENGINEERING']['TP_PCT'] = 0.015
config['FEATURE_ENGINEERING']['SL_PCT'] = 0.010
