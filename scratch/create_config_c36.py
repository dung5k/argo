...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_040700_v6_weekend_continuous_36\config.json'
...
config['FEATURE_ENGINEERING']['TP_PCT'] = 0.010
config['FEATURE_ENGINEERING']['SL_PCT'] = 0.006
