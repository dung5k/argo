...
out_path = r'd:\DungLA\client1\workspaces\CFG_LTC_WEEKEND_V6\runs\run_20260510_090100_v6_weekend_continuous_57\config.json'
...
config['FEATURE_ENGINEERING']['SL_PCT'] = 0.0025
config['FEATURE_ENGINEERING']['MAX_HOLD_BARS'] = 24

config['FEATURE_ENGINEERING']['MTF_INPUTS'][0]['TIMEFRAME'] = '5min'
config['FEATURE_ENGINEERING']['MTF_INPUTS'][0]['WINDOW_SIZE'] = 36
