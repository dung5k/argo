...
CONFIG_PATH = r"workspaces\CFG_LTC_LONDON_V3_5\runs\run_20260501_101105_v4_ldn_auto_48\config.json"
RUN_ID = "run_20260501_101105_v4_ldn_auto_48"
...
subprocess.run('python .agent\\send_to_tele.py "Đã hoàn thành lượt Training Auto-Tuning ngầm cho LTC London (Run 48: Thử nghiệm Focal Gamma 3.0)! Hệ thống tiếp tục vào trạng thái chờ lượt tiếp theo." --done', shell=True, env={**os.environ, "PYTHONIOENCODING": "utf8"})
