...
print("=== METHOD 3: HIGH PENALTY EWC FINETUNING OPT-12 (2026 Jan-Apr) & TESTING (May-Present) ===")
...
# Step 1: Compute Fisher Information Matrix on old data (split_20_train)
print("\nComputing Fisher Matrix on old data (Split 20)...")
old_train = pd.read_parquet("data/v8_splits/split_20_train.parquet")
...
ewc_lambda = 25000.0  # Penalty strength
...
print("\nBuilding Train Dataset (2026 Jan-Apr)...")
...
print("\nBuilding Test Dataset (2026 May-Present)...")
...
out_name = f"v8_configs/hall_of_fame/{base_mname}_FTM3_PnL{total_pnl:+.0f}_{ts}.pt"
torch.save(model.state_dict(), out_name)
print(f"Saved: {out_name}")

print("=== EWC FINETUNING ON 2026 DATA COMPLETED ===")
