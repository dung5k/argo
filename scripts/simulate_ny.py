...
def main():
    ...
    parser.add_argument("--session", type=str, default="ny", choices=["asian", "london", "ny"], help="Phiên giao dịch")
    parser.add_argument("--notify", action="store_true", help="Gửi thông báo Telegram")
    args = parser.parse_args()

    master_cfg_path = args.config if hasattr(args, 'config') and args.config else "bot_config_v6_xag_asian.json"
