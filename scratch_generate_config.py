...
cfg['FEATURE_ENGINEERING']['TP_PIPS'] = 50
cfg['FEATURE_ENGINEERING']['SL_PIPS'] = 50
cfg['FEATURE_ENGINEERING']['WINDOW_SIZE'] = 15

cfg['TRAINING']['D_MODEL'] = 32
...
if config_hash in tried_configs:
    ...
    run_id = f'run_{datetime.now().strftime("%Y%m%d_%H%M%S")}_v3_ny_auto_1'
