...
### 9. `run_20260428_214500_v4_ny_15` (Đang tiến hành)
- **Tham số thay đổi:** Cấu hình chuẩn Baseline 100% (Pure Macro, `WINDOW=20`, `LEARNING_RATE=1e-5`). Đổi chiến thuật nhãn: `TP_PIPS=80`, `SL_PIPS=80`, `MAX_HOLD_BARS=30`.
