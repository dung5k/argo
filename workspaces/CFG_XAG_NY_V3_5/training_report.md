...
### 19. `run_20260429_010500_v4_ny_25` (Đang tiến hành)
- **Tham số thay đổi:** Cấu hình chuẩn New Baseline (Pure Macro, `TP=80/SL=80`, `MAX_HOLD_BARS=30`). Tinh chỉnh `WINDOW_SIZE` từ 20 lên 30.
- **Kỳ vọng:** Việc mở rộng độ dài chuỗi thời gian phân tích lên 90 phút (30 nến x 3 phút/bước) sẽ cung cấp thêm Context (Bối cảnh) về dòng chảy thanh khoản chuyển giao từ phiên London sang New York. Kỳ vọng mạng sẽ đưa ra quyết định vững chắc hơn và phá vỡ ngưỡng điểm 0.549.
