...
def main():
    workspace = os.path.join(_ROOT, "workspaces", "CFG_LTC_LONDON_V6")
    ...
    scaler_path = os.path.join(run_dir, "brains", "scaler_CFG_LTC_LONDON_V6.pkl")
    ...
    while current_date <= end_date:
        ...
        safe_log(f"\n---> RUNNING SIMULATION LONDON FOR DATE: {d_str}")
        try:
            sim.run(d_str, session="london")
