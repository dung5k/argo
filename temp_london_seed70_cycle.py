...
run_id = f'run_{run_timestamp}_v6_LONDON_5m_TP8_SL3_Drop30_W15_FarmSeed70'
...
# ---- APPEND DIARY ----
diary_text = """
### STATE UPDATE: 2026-05-14 09:53
- **Run ID:** run_20260514_094415_v6_LONDON_5m_TP8_SL3_Drop30_W15_FarmSeed69
- **Kết quả:** Best Val Loss tại Epoch 3 (Đáy mới: **0.4992**). Composite Score: **0.1700**, Win Rate: **27.00%** (Threshold 0.80), **51.28%** (Threshold 0.93, N=39).
- **Phân tích:** Val Loss tiếp tục phá đáy xuống 0.4992 (thấp nhất từ trước đến nay). Score nhích nhẹ lên 0.1700 tròn trĩnh, và WR ở phân khúc 0.93 tăng lên 51.28%. Hệ thống hoàn toàn làm chủ được "nhiễu" của phiên London, các lệnh lọc ở ngưỡng cao có độ chính xác rất đáng tin cậy.
- **Ý tưởng tiếp theo (Seed 70):** Khởi động con số tròn trĩnh Seed 70! Tiếp tục duy trì tham số vàng này.
"""
with codecs.open('workspaces/CFG_LTC_LONDON_V6/LONDON_V6_DIARY.md', 'a', encoding='utf-8') as f:
    f.write(diary_text)

# ---- TELEGRAM REPORT THEO MẪU ----
msg = f"""🏯 [LONDON V6 MTF] Tạo Run Mới (FarmSeed 70).

📊 Kết quả FarmSeed 69:
- Best Val Loss tại Epoch 3. Composite Score: 0.1700
- Win Rate: 27.00% (Threshold 0.80) | 51.28% (Threshold 0.93)
...
🚨 Tin Vui: Val Loss vừa lập đáy MỚI (0.4992) – Cấu trúc mô hình đang "siết" dữ liệu London ngày càng chặt! Win Rate phân khúc cao bứt tốc qua mốc 51%. 🚀 FarmSeed 70 (PID {pid}) đã bùng cháy! Mục tiêu: Tiếp tục bòn vàng!"""
