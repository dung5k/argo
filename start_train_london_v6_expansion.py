...
run_id = "run_20260525_013000_v6_london_mtf_expansion"
config_path = r"workspaces\CFG_XAG_LONDON_V6\runs\run_20260525_013000_v6_london_mtf_expansion\config.json"
env = dict(os.environ,
...
print("Starting London V6 MTF Expansion Training on CPU (scratch)...")
log_file = open("train_v6_london_expansion.log", "w", encoding="utf-8")
