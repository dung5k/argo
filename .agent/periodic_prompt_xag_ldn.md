...
5. **Early Stopping (Dừng Task):**
   - **KHÔNG BAO GIỜ TỰ ĐỘNG DỪNG TASK NÀY.** Hãy chạy liên tục và liên tục thử nghiệm các tham số khác nhau, cho đến khi user trực tiếp yêu cầu dừng. Bỏ qua mọi điều kiện dừng sớm.
