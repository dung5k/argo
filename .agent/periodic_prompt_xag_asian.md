...
3. **Đánh giá & Điều chỉnh Features (Feature Engineering):**
   ...
   - *Chiến lược mới:* Đánh nhanh rút gọn (TP/SL nhỏ: 25-30 pips). Giữ mạng bộ não nhỏ (D_MODEL=16/32) để không bị overfit với nhiễu của phiên Á. Mặc định `ZERO_NOISE_TARGET: false`.
