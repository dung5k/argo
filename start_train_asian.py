...
run_id = "run_20260524_063400_v6_asian_init"
config_path = r"workspaces\CFG_XAG_ASIAN_V6\runs\run_20260524_063400_v6_asian_init\config.json"
...
print("Generating new dataset tensors for ASIAN V6...")
...
print("Dataset generation completed. Starting Asian V6 training on GPU...")
log_file = open("train_v6_asian.log", "w", encoding="utf-8")
