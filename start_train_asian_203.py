...
sp1 = subprocess.run([sys.executable, "scripts/prepare_v6_dataset.py", "--config", r"workspaces\CFG_LTC_ASIAN_V6\runs\run_20260515_130856_v6_ASIAN_5m_TrueDataset_TripleFusion_203\config.json", "--no-upload"], env=env)
if sp1.returncode != 0:
    print("FATAL ERROR: prepare_v6_dataset failed!")
    sys.exit(1)

print(">>> [PHASE 2] INJECT TENSORS INTO RUN DIRECTORY...", flush=True)
run_dir_tensors = r"workspaces\CFG_LTC_ASIAN_V6\runs\run_20260515_130856_v6_ASIAN_5m_TrueDataset_TripleFusion_203/data/tensors"
...
proc = subprocess.Popen([sys.executable, "-u", "src/training_v6/train_v6.py", r"workspaces\CFG_LTC_ASIAN_V6\runs\run_20260515_130856_v6_ASIAN_5m_TrueDataset_TripleFusion_203\config.json", "--run-id", "run_20260515_130856_v6_ASIAN_5m_TrueDataset_TripleFusion_203"], stdout=open("train_v6_asian.log", "w", encoding="utf-8"), stderr=subprocess.STDOUT, env=env)
print("PID:", proc.pid)
